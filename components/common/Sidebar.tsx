...
const SpaceSwitcher: React.FC = () => {
    ...
    return (
        <div className="relative mb-6">
            ...
            {isOpen && (
                <div className="absolute top-full mt-2 w-full bg-white dark:bg-gray-700 rounded-lg border dark:border-gray-600 z-10 py-1">
...
const Sidebar: React.FC<SidebarProps> = ({ activeItem, onNavigate }) => {
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen fixed top-0 left-0 bg-white dark:bg-dark-card border-r border-gray-200 dark:border-dark-border z-50 p-4">
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-4 py-3 rounded-lg text-md transition-colors w-full text-left ${
              activeItem === name
                ...
                : 'text-gray-600 dark:text-text-secondary hover:bg-gray-100 dark:hover:bg-gray-700'
            }`}
          >
